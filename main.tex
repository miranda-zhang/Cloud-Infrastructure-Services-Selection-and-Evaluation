...
% https://tex.stackexchange.com/a/101138/34958
\usepackage{scalerel}
...
{   
    ...
    \lstset{ %this is the stype
        ...
        keywords={,input, output, return, datatype, function, in, if, else, then, foreach, do, while, begin, end, } %add the keywords you want, or load a language as Rubens explains in his comment above.
        numbers=left,
...
% ----------------------------------------------------------------------------------------
% clever reference
% https://tex.stackexchange.com/questions/47495/cleveref-listings
% https://tex.stackexchange.com/questions/239970/is-cleveref-safe-to-use
% ----------------------------------------------------------------------------------------
\AtEndPreamble{\usepackage{cleveref}} 
\AtEndPreamble{\crefname{lstlisting}{listing}{listings}}

% ----------------------------------------------------------------------------------------
% https://tex.stackexchange.com/questions/50070/landscape-figure-in-latex
% https://tex.stackexchange.com/questions/146878/sideways-figure-always-rotates-clockwise
% ----------------------------------------------------------------------------------------
